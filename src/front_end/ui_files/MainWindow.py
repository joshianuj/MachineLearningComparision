...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mode_frame.setGeometry(QtCore.QRect(50, 20, 221, 111))
        ...
        self.files_frame.setGeometry(QtCore.QRect(50, 150, 311, 501))
        ...
        self.scrollArea.setGeometry(QtCore.QRect(370, 20, 1061, 411))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollArea_widget = QtWidgets.QWidget()
        self.scrollArea_widget.setGeometry(QtCore.QRect(0, 0, 1059, 409))
        ...
        self.scrollAreaEcho = QtWidgets.QScrollArea(MainWindow)
        self.scrollAreaEcho.setGeometry(QtCore.QRect(370, 440, 1061, 401))
        self.scrollAreaEcho.setWidgetResizable(True)
        self.scrollAreaEcho.setObjectName("scrollAreaEcho")
        self.scrollArea_widget_2 = QtWidgets.QWidget()
        self.scrollArea_widget_2.setGeometry(QtCore.QRect(0, 0, 1059, 399))
        self.scrollArea_widget_2.setObjectName("scrollArea_widget_2")
        self.scrollAreaEcho.setWidget(self.scrollArea_widget_2)
